<xsl:stylesheet version="2.0" xmlns:xsl ="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Subtemplate mode - overrides for iso19139 are placed in here
	     -->
  <xsl:template name="iso19115-2-subtemplate">
		<xsl:variable name="19115-2Elements">
			<xsl:apply-templates mode="iso19115-2-subtemplate" select="."/>
		</xsl:variable>
  ...
  <xsl:template mode="iso19115-2-subtemplate" match="*"/>
