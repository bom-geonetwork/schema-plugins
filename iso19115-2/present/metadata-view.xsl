...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  exclude-result-prefixes="gmi gmx xsi gmd gco gml gts srv xlink exslt geonet">
  ...
  <!-- ===================================================================== -->
  <xsl:template name="view-with-header-iso19115-2">
		<xsl:param name="tabs"/>
  ...
  <!-- View templates are available only in view mode and do not provide 
	     editing capabilities. -->
  <!-- ===================================================================== -->
  <xsl:template name="metadata-iso19115-2view-simple" match="metadata-iso19115-2view-simple">
		<xsl:call-template name="view-with-header-iso19115-2">
