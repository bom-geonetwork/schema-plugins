	...
	<xsl:template match="gmi:MI_Metadata">
		...
		<csw:Record>
			...
			<xsl:for-each select="gmd:identificationInfo/gmd:MD_DataIdentification">
				...
				<xsl:for-each select="gmd:extent/*/gmd:temporalElement/gmd:EX_TemporalExtent/gmd:extent/gml32:TimePeriod">
					<dc:coverage>name="<xsl:value-of select="@gml32:id"/>"; start="<xsl:value-of select="gml32:beginPosition|gml32:begin/gml32:TimeInstant/gml32:timePosition"/>"; end="<xsl:value-of select="gml32:endPosition|gml32:end/gml32:TimeInstant/gml32:timePosition"/>"
					</dc:coverage>
				</xsl:for-each>
