...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="briefster" match="*">
    ...
    <xsl:for-each select="gmd:extent/*/gmd:temporalElement/*/gmd:extent/gml32:TimePeriod">
      <temporalExtent>
        <begin>
          <xsl:apply-templates mode="brieftime"
            select="gml32:beginPosition|gml32:begin/gml32:TimeInstant/gml32:timePosition"/>
        </begin>
        <end>
          <xsl:apply-templates mode="brieftime"
            select="gml32:endPosition|gml32:end/gml32:TimeInstant/gml32:timePosition"/>
        </end>
      </temporalExtent>
    </xsl:for-each>
